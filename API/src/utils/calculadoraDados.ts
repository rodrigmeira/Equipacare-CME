export const calculadoraDados = ({
  ...
  const NumeroDeCirurgiasPorDia = NumeroSalasCirurgicas * NumeroCirurgiasSalaDia;
  ...
  const EstimativaVolumeTotalDiarioPorMaterial = VolumeTotalDiarioInternacao + VolumeTotalDiarioUTIs + VolumeTotalDiarioCirurgias;
  const EstimativaDeVolumeTotalDiarioUE = EstimativaVolumeTotalDiarioPorMaterial * 2;
  const EstimativaDeVolumeTotalDiarioLitros = Math.ceil(EstimativaDeVolumeTotalDiarioUE * 54);
