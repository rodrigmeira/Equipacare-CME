...
export const WrapperForm = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="flex flex-col justify-center items-center p-2 mb-24" >
      <div className="grid md:grid-cols-2 gap-0 lg:w-[1150px] md:h-auto w-[98%] h-auto items-center justify-center shadow-lg rounded-3xl overflow-hidden">
